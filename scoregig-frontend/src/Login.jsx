...
import { Megaphone, ClipboardList, DollarSign } from "lucide-react";
...
export default function Login({ onAuthed }) {
  ...
  return (
    <div className="min-h-screen" style={{ backgroundColor: C.navy }}>
      ...
      {/* HOW IT WORKS — one card per side of the marketplace */}
        ...
        <div className="grid gap-3 sm:grid-cols-2">
          <div className="rounded-2xl border p-4" style={{ borderColor: "rgba(255,255,255,0.15)", backgroundColor: "rgba(255,255,255,0.05)" }}>
            ...
            <p className="mt-1 text-[13px] leading-relaxed" style={{ color: "rgba(255,255,255,0.75)" }}>
              Post the date, time, rink, and pay — a scorekeeper claims it. No subscription and nothing charged
              upfront; your card is only billed once you approve someone.
            </p>
          </div>
          <div className="rounded-2xl border p-4" style={{ borderColor: "rgba(255,255,255,0.15)", backgroundColor: "rgba(255,255,255,0.05)" }}>
            ...
            <p className="mt-1 text-[13px] leading-relaxed" style={{ color: "rgba(255,255,255,0.75)" }}>
              Browse open gigs near you, claim the ones that fit your schedule, and get paid directly.
              No experience required to sign up.
            </p>
          </div>
        </div>
        <div className="mt-3 flex items-center justify-center gap-1.5 text-[12px] font-semibold" style={{ color: "rgba(255,255,255,0.6)" }}>
          <DollarSign size={14} color={C.amber} />
          Scorekeepers keep 100% of their listed pay.
        </div>
      </div>
